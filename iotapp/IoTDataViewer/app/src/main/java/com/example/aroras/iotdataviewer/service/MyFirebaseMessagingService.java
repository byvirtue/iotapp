package com.example.aroras.iotdataviewer.service;
...
import com.example.aroras.iotdataviewer.conf.*;
import com.example.aroras.iotdataviewer.utils.*;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        int flag=0;
        if(change==null && remoteMessage !=null)
            flag=1;
        if (flag==0 &&( remoteMessage == null || change.equals("off")))
            return;
